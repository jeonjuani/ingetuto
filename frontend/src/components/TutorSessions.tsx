    ...
    return (
        <div className="student-browser">
            <div className="availability-header">
                ...
                <p style={{ color: '#666' }}>Aquí puedes gestionar tus tutorías y enlaces de comunicación.</p>
            </div>
                        ...
                        <div key={tutoria.idTutoria} className="tutor-card">
                            <div className="tutor-header">
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <span className="tutor-name" style={{ fontSize: '15px' }}>{tutoria.nombreEstudiante}</span>
                                </div>
                                <span
                                    style={{
                                        padding: '4px 12px',
                            ...
                            {tutoria.observaciones && (
                                <div style={{ marginTop: '16px', padding: '12px', backgroundColor: '#fffbeb', borderRadius: '12px', border: '1px solid #fef3c7' }}>
                                    <p style={{ margin: 0, fontSize: '13px', color: '#92400e', lineHeight: '1.5' }}>
                                        <strong style={{ display: 'block', marginBottom: '2px', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Observaciones del Estudiante:</strong>
                                        {tutoria.observaciones}
                                    </p>
                                </div>
                            )}
                            ...
                            {tutoria.estado === 'PROGRAMADA' && (
                                <div style={{ 
                                    marginTop: '16px', 
                                    padding: '10px', 
                                    backgroundColor: tutoria.confirmacionTutor ? '#f0fdf4' : '#eff6ff', 
                                    borderRadius: '10px',
                                    border: `1px solid ${tutoria.confirmacionTutor ? '#bbf7d0' : '#bfdbfe'}`
                                }}>
                                    <p style={{ margin: 0, fontSize: '12px', color: tutoria.confirmacionTutor ? '#166534' : '#1e40af', fontWeight: '500' }}>
                                        {tutoria.confirmacionTutor ? (
                                            <span>✓ Asistencia confirmada</span>
                                        ) : tutoria.confirmacionEstudiante ? (
                                            <span>Estudiante confirmó. ¡Confirma tú también!</span>
                                        ) : (
